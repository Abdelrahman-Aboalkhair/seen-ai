 ...
 */
router.post("/async/file", upload.single("cvFile"), async (req, res) => {
  try {
    ...
    console.log("✅ [CV File Route] CV analysis job created successfully:", {
      jobId,
      userId,
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        uploadDirectory: stats.uploadDirectory,
      },
