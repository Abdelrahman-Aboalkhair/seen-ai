...
export class InterviewAnalysisService extends BaseAIService {
    async analyzeInterviewResults(request) {
        ...
        try {
            ...
            const result = await this.withRetry(() => this.generateInterviewAnalysis(request), 'analyze_interview');
    ...
    async generateInterviewAnalysis(request) {
    ...
    `;
        ...
        return this.parseJsonResponse(content, 'interview_analysis');
    }
    async analyzeQuestionPerformance(questionId, question, answer, expectedAnswer) {
    ...
    async generateInterviewSummary(candidateName, position, overallScore, strengths, weaknesses, recommendations) {
...
//# sourceMappingURL=interview-analysis.service.js.map