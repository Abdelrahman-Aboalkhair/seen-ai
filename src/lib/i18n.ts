...
const translations = {
  ar: {
    ...
    'pricing.subtitle': 'حزم مرنة وفعالة لتلبية جميع احتياجاتك في التوظيف والبحث عن المواهب',
    ...
    'services.cv_analysis.description': 'تحليل ذكي للسير الذاتية باستخدام الذكاء الاصطناعي',
    ...
    'company.description': 'حلول الذكاء الاصطناعي المتقدمة لاكتشاف وتحليل المواهب. نهدف إلى تحويل عالم التوظيف باستخدام أحدث تقنيات الذكاء الاصطناعي.',
    ...
    'services.cv_analysis.upload_instruction': 'اضغط لرفع السير الذاتية أو اسحبها هنا',
    ...
    'services.talent_search.comprehensive_description': 'بحث شامل وكامل مع أعلى دقة',
    'services.talent_search.processing_notice': 'الدرجات الأعلى تستغرق وقتاً أطول لكن تقدم نتائج أكثر دقة',
    ...
    'form.placeholder.skills_required': 'مثال: JavaScript, React, Node.js, Python',
    ...
    'homepage.hero.description': 'اكتشف أفضل المواهب وحلل السير الذاتية بتقنية الذكاء الاصطناعي المتقدمة. وفر وقتك واحصل على أفضل النتائج في عملية التوظيف.',
    ...
    'homepage.features.subtitle': 'استخدم قوة الذكاء الاصطناعي لتحويل عملية التوظيف إلى تجربة ذكية وفعالة',
    'homepage.features.ai_talent_search.title': 'البحث عن المواهب بالذكاء الاصطناعي',
    'homepage.features.ai_talent_search.description': 'اعثر على أفضل المرشحين باستخدام خوارزميات الذكاء الاصطناعي المتقدمة',
    'homepage.features.cv_analysis.title': 'تحليل السيرة الذاتية',
    'homepage.features.cv_analysis.description': 'حلل مئات السير الذاتية فوراً واحصل على أفضل المطابقات',
    'homepage.features.smart_management.title': 'إدارة المواهب الذكية',
    'homepage.features.smart_management.description': 'نظام شامل لإدارة وتتبع المرشحين وعملية التوظيف',
    'homepage.features.instant_results.title': 'نتائج فورية',
    'homepage.features.instant_results.description': 'احصل على نتائج دقيقة وفورية مع تقارير مفصلة وقابلة للتحميل',
    
    'homepage.pricing_section.title': 'حزم مرنة لجميع الاحتياجات',
    'homepage.pricing_section.subtitle': 'اختر الحزمة التي تناسب احتياجاتك وابدأ في استخدام قوة الذكاء الاصطناعي',
    'homepage.pricing_section.starter.name': 'المبتدئ',
    'homepage.pricing_section.starter.features.credits': 'كريديت',
    'homepage.pricing_section.starter.features.search_candidates': 'البحث عن 50 مرشح',
    'homepage.pricing_section.starter.features.analyze_cvs': 'تحليل 100 سيرة ذاتية',
    ...
    'homepage.pricing_section.professional.features.search_candidates': 'البحث عن 150 مرشح',
    'homepage.pricing_section.professional.features.analyze_cvs': 'تحليل 300 سيرة ذاتية',
    'homepage.pricing_section.professional.features.advanced_reports': 'تقارير متقدمة',
    'homepage.pricing_section.professional.features.priority_support': 'دعم أولوية',
    'homepage.pricing_section.enterprise.name': 'المؤسسي',
    'homepage.pricing_section.enterprise.features.credits': 'كريديت',
    'homepage.pricing_section.enterprise.features.unlimited_search': 'بحث غير محدود',
    'homepage.pricing_section.enterprise.features.unlimited_analysis': 'تحليل غير محدود',
    'homepage.pricing_section.enterprise.features.custom_api': 'API مخصص',
    'homepage.pricing_section.enterprise.features.account_manager': 'مدير حساب مخصص',
    ...
    'homepage.cta.subtitle': 'انضم إلى آلاف الشركات التي تثق في SEEN AI للعثور على أفضل المواهب',
  ...
  en: {
    ...
    'pricing.subtitle': 'Flexible and effective packages to meet all your recruitment and talent search needs',
    ...
    'services.cv_analysis.description': 'Smart CV analysis using artificial intelligence',
    ...
    'company.description': 'Advanced artificial intelligence solutions for talent discovery and analysis. We aim to transform the world of recruitment using the latest AI technologies.',
    ...
    'services.cv_analysis.upload_instruction': 'Click to upload CVs or drag them here',
    ...
    'services.talent_search.balanced_description': 'Balanced search with more details',
    'services.talent_search.detailed_description': 'Detailed search with deep analysis',
    'services.talent_search.comprehensive_description': 'Comprehensive and complete search with highest accuracy',
    'services.talent_search.processing_notice': 'Higher scores take longer but provide more accurate results',
    ...
    'form.placeholder.job_description': 'Describe the role, responsibilities, and expectations...',
    'form.placeholder.skills_required': 'e.g., JavaScript, React, Node.js, Python',
    ...
    'homepage.hero.description': 'Discover the best talent and analyze resumes with advanced artificial intelligence technology. Save your time and get the best results in the hiring process.',
    ...
    'homepage.features.subtitle': 'Use the power of artificial intelligence to transform the hiring process into a smart and efficient experience',
    'homepage.features.ai_talent_search.title': 'AI-Powered Talent Search',
    'homepage.features.ai_talent_search.description': 'Find the best candidates using advanced artificial intelligence algorithms',
    'homepage.features.cv_analysis.title': 'CV Analysis',
    'homepage.features.cv_analysis.description': 'Analyze hundreds of resumes instantly and get the best matches',
    'homepage.features.smart_management.title': 'Smart Talent Management',
    'homepage.features.smart_management.description': 'Comprehensive system for managing and tracking candidates and hiring process',
    'homepage.features.instant_results.title': 'Instant Results',
    'homepage.features.instant_results.description': 'Get accurate and instant results with detailed and downloadable reports',
    
    'homepage.pricing_section.title': 'Flexible Packages for All Needs',
    'homepage.pricing_section.subtitle': 'Choose the package that suits your needs and start using the power of artificial intelligence',
    'homepage.pricing_section.starter.name': 'Starter',
    'homepage.pricing_section.starter.features.credits': 'Credits',
    'homepage.pricing_section.starter.features.search_candidates': 'Search for 50 Candidates',
    'homepage.pricing_section.starter.features.analyze_cvs': 'Analyze 100 CVs',
    'homepage.pricing_section.starter.features.support': '24/7 Technical Support',
    'homepage.pricing_section.professional.name': 'Professional',
    'homepage.pricing_section.professional.features.credits': 'Credits',
    'homepage.pricing_section.professional.features.search_candidates': 'Search for 150 Candidates',
    'homepage.pricing_section.professional.features.analyze_cvs': 'Analyze 300 CVs',
    'homepage.pricing_section.professional.features.advanced_reports': 'Advanced Reports',
    'homepage.pricing_section.professional.features.priority_support': 'Priority Support',
    'homepage.pricing_section.enterprise.name': 'Enterprise',
    'homepage.pricing_section.enterprise.features.credits': 'Credits',
    'homepage.pricing_section.enterprise.features.unlimited_search': 'Unlimited Search',
    'homepage.pricing_section.enterprise.features.unlimited_analysis': 'Unlimited Analysis',
    'homepage.pricing_section.enterprise.features.custom_api': 'Custom API',
    'homepage.pricing_section.enterprise.features.account_manager': 'Dedicated Account Manager',
    ...
    'homepage.cta.subtitle': 'Join thousands of companies that trust SEEN AI to find the best talent',
