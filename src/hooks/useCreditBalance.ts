...
export function useCreditBalance() {
  ...
  const deductCredits = async (amount: number, description: string = t('dashboard.credit_usage')) => {
    try {
  ...
  const addCredits = async (amount: number, description: string = t('pricing.buy_now')) => {
    try {
