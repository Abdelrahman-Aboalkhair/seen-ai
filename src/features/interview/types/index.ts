...
export const TEST_TYPES: TestType[] = [
  {
    ...
    description: 'تحليل السلوك أثناء الإجابات (نبرة الصوت، التوقفات، تعابير الوجه)',
  ...
  },
  {
    ...
    description: 'تقييمات المهارات المتعلقة بالوظيفة (المبيعات، التسويق، البرمجة، المحاسبة)',
  ...
  },
  {
    ...
    description: 'أسئلة موقفية تقيم التعاطف، التنظيم الذاتي، المهارات الاجتماعية',
  ...
  },
  {
    ...
    description: 'تحديات البرمجة الخاصة بالدور، دراسات الحالة، أو المهام القائمة على الأدوات',
  ...
  },
  {
    ...
    description: 'المفردات، القواعد، الفهم، والتواصل التجاري (اختر اللغة المطلوبة)',
