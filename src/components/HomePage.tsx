...
export function HomePage() {
  ...
  const stats = [
    {
      number: "10,000+",
      label: t("homepage.stats.candidates_analyzed" as any),
    },
  ...
  const packages = [
    ...
    },
    {
      ...
      features: [
        `1500 ${t(
          "homepage.pricing_section.professional.features.credits" as any
        )}`,
        t(
          "homepage.pricing_section.professional.features.search_candidates" as any
        ),
        t("homepage.pricing_section.professional.features.analyze_cvs" as any),
        t(
          "homepage.pricing_section.professional.features.advanced_reports" as any
        ),
        t(
          "homepage.pricing_section.professional.features.priority_support" as any
        ),
      ],
      popular: true,
    },
    {
      ...
      features: [
        `3500 ${t(
          "homepage.pricing_section.enterprise.features.credits" as any
        )}`,
        t(
          "homepage.pricing_section.enterprise.features.unlimited_search" as any
        ),
        t(
          "homepage.pricing_section.enterprise.features.unlimited_analysis" as any
        ),
        t("homepage.pricing_section.enterprise.features.custom_api" as any),
        t(
          "homepage.pricing_section.enterprise.features.account_manager" as any
        ),
      ],
    },
  ];
            ...
            >
              <div className="flex items-center justify-center lg:justify-start mb-6">
                ...
                <span className="text-cyan-400 font-medium">
                  {t("homepage.hero.ai_powered" as any)}
                </span>
              </div>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
                ...
                <span className="text-white">
                  {t("homepage.hero.with_ai" as any)}
                </span>
              </h1>
            ...
            {features.map((feature, index) => (
              ...
              >
                <Card className="h-full hover:transform hover:scale-105 transition-all duration-300 group">
                  <CardContent>
                    <div
                      className={`w-16 h-16 rounded-lg bg-gradient-to-r ${feature.gradient} p-4 mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <div className="inline-flex items-center bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full px-6 py-3 backdrop-blur-sm">
                <span className="text-green-400 font-semibold text-lg">
                  Save 40% when upgrading from Basic to Pro
                </span>
                <Sparkles className="ml-2 h-5 w-5 text-green-400" />
              </div>
            </motion.div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <Card
                  className={`h-full ${
                    pkg.popular ? "border-cyan-500/50 shadow-cyan-500/20" : ""
                  }`}
                >
                  <CardContent>
                    <div className="text-center">
                      ...
                      <div className="mb-6">
                        ...
                        <span className="text-gray-400 text-lg">
                          {" "}
                          {t("homepage.pricing_section.sar" as any)}
                        </span>
                        {pkg.discount > 0 && (
                          <div className="text-sm text-green-400 mt-1">
                            {t("homepage.pricing_section.save_percent" as any)}{" "}
                            {pkg.discount}%
                          </div>
                        )}
                      </div>
