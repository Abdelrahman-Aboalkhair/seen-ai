...
export function CreditHistoryPage() {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      const formattedTransactions: CreditTransaction[] = (data || []).map(
        (item) => ({
          id: item.id,
          user_id: item.user_id,
          amount: Math.abs(item.credits_amount),
          type: item.transaction_type,
          description: item.description,
          service_used: item.description?.split(" - ")[0] || "unknown",
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">{t("dashboard.credit_usage")}</p>
      </div>
              ...
              >
                ...
                <div className={`text-right ${isRTL() ? "text-left" : ""}`}>
                  ...
                  >
                    ...
                    {transaction.amount} {t("credit.balance")}
                  </p>
                </div>
              </div>
            ))}
