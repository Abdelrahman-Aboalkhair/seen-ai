    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        const transformedPackages = data.map((pkg) => ({
          ...
          description:
            language === "ar"
              ? getArabicPackageDescription(pkg.name)
              : pkg.description,
        }));
      ...
      const fallbackPackages: CreditPackage[] = [
        {
          ...
          description:
            language === "ar"
              ? "مثالية للشركات الصغيرة والأفراد"
        ...
        },
        {
          ...
          description:
            language === "ar"
              ? "الأكثر شعبية للشركات المتوسطة"
              : "Most popular for medium businesses",
        },
        {
          id: "3",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {packages.map((pkg, index) => {
            ...
            const isPopular =
              pkg.name.includes("المحترف") || pkg.name.includes("Professional");
